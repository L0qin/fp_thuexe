...
ADD COLUMN `loai_nguoi_dung` INT DEFAULT 0;
CREATE TABLE IF NOT EXISTS `danhgia` (
  ...
  CONSTRAINT `danhgia_ibfk_1` FOREIGN KEY (`ma_xe`) REFERENCES `xe` (`ma_xe`),
  CONSTRAINT `danhgia_ibfk_2` FOREIGN KEY (`ma_nguoi_dung`) REFERENCES `nguoidung` (`ma_nguoi_dung`)
...
CREATE TABLE IF NOT EXISTS `thongtinxe` (
  ...
  KEY `ma_xe` (`ma_xe`),
  CONSTRAINT `thongtinxe_ibfk_1` FOREIGN KEY (`ma_xe`) REFERENCES `xe` (`ma_xe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

CREATE TABLE IF NOT EXISTS `lichsume` (
  ...
  CONSTRAINT `lichsume_ibfk_1` FOREIGN KEY (`ma_xe`) REFERENCES `xe` (`ma_xe`),
  CONSTRAINT `lichsume_ibfk_2` FOREIGN KEY (`ma_nguoi_thue`) REFERENCES `nguoidung` (`ma_nguoi_dung`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
