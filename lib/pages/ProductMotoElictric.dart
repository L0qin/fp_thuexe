...
class ProductMotoElictrics extends StatefulWidget {
  static const title = 'Thuê xe';

  @override
  _ProductMotoElictricsState createState() => _ProductMotoElictricsState();
}

class _ProductMotoElictricsState extends State<ProductMotoElictrics> {
